...
CREATE TABLE IF NOT EXISTS `bank`.`Clients` (
  ...
  CONSTRAINT `fk_Clients_Manager1`
    ...
    REFERENCES `bank`.`Manager` (`idManagers`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
INSERT INTO Clients (name,last_name,date_of_birth,document,email,account_id,manager_id) VALUES ('Hermione','Potter','31/07/1980',21123456,'harrypotter@gmail.com',1,1);
INSERT INTO Clients (name,last_name,date_of_birth,document,email,account_id,manager_id) VALUES ('Harry','Granger','19/09/1979',22123456,'hermionegranger@gmail.com',2,1);
